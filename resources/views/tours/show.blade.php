						...
						<aside id="text-15" class="widget_text">
							<div class="textwidget">
								<ul class="top_bar_info clearfix">
									...
									<li><i class="fa fa-envelope-o"></i>info@jahongir-travel.com</li>
								</ul>
					...
					<div class="images images_single_left">
						...
						<div class="single-tour-tabs wc-tabs-wrapper">
												...
												<div class="content-inner">
													<div class="row">
														...
														<div class="col-sm-10">
															...
															<ul class="sub-menu">
																<li> Individual and group tours to Uzbekistan and Central Asia </li>
														...
														<tbody>
                                                            @if (!empty($tour->tour_excludes))
                                                                <ul>
                                                                    ...
                                                                    <tr>
                                                                        <td><i class="fa fa-check icon-tick icon-tick--on"></i>{{ $exclude['name'] }}
                                                                        </td>
													...
													<table>
														<tbody>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <tr>
                                                                    <td><i class="fa fa-check icon-tick icon-tick--on"></i>{{ $include['name'] }}
                                                                    </td>
													...
													<table class="table">
														...
														<tbody>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">{{ $price['number_people'] }}</th>
																    <td>{{ $price['price'] }}$</td>
							...
							@endforeach
								...
								<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--gallery_tab panel entry-content wc-tab" id="tab-gallery_tab">
									...
									<div class="item_border item-product">
										...
										<div class="wrapper_content">
											...
											<div class="description">
												<p>Immerse yourself in ancient history and be amazed by the magnificient monuments of the legendary city Samarkand. </p>
											</div>
										</div>
										<div class="read_more">
...
<div class="summary entry-summary description_single">
										...
										<div class="">
											...
											<form action="" method="post" id="tourBookingForm" >
												...
												<input class="btn-booking btn" name='submit' value="Book now" type="submit">
													...
													<input type="hidden" name="tour_name" value="Daytrip to Shahrisabz" />
					<input type="hidden" name="tour_code" value="ShahD" />
		...
		<script async src="https://www.jscache.com/wejs?wtype=cdswritereviewlgvi&amp;uniq=434&amp;locationId=17475559&amp;lang=en_US&amp;lang=en_US&amp;display_version=2" data-loadtrk onload="this.loadtrk=true"></script>
				...
				<div class="wrapper-special-tours">
					...
					<div class="inner-special-tours">
						<a href="nuratau-homestay-2-days.php">
							<img width="430" height="305" src="images/nuratau/homestay-in-nuratau-mountains.jpg" alt="family-asraf-village" title="homestay-nuratau-2-days">
						</a>

						<div class="post_title">
							<h3>
								<a href="nuratau-homestay-2-days.php" rel="bookmark">Live like a Local in Asraf village</a>
							</h3>
						</div>
						<div class="item_price">
...
<div class="wrapper-footer wrapper-footer-newsletter">
						...
						<div class="textwidget">
							<div class="footer-info">
								...
								<ul class="contact-info">
									...
									<li>
										<i class="fa fa-envelope fa-fw"></i><a href="mailto:info@jahongir-travel.com">info@jahongir-travel.com</a>
									</li>
								</ul>
							</div>
						</div>
		...
		<div class="container wrapper-copyright">
			<div class="row">
				<div class="col-sm-6">
					<div><p>Copyright © 2017 Jahongir Travel. All Rights Reserved.</p></div>
				</div>
				<div class="col-sm-6">
