										...
										<form action="" method="post" id="tourBookingForm">
											...
											<div class="">
												<input name="phone" value=""
													placeholder="Whatsapp phone w/country code" type="text"
													required>
											</div>
											<div class="">
												<input name="hotel_to_pickup" value=""
													placeholder="Name of the hotel to pick up" type="text"
													required>
											</div>
											<div class="">
												<input type="text" id="date" name="departure_date"
													placeholder="Departure Date" class="hasDatepicker" required>
											</div>
												...
												<div class="total_price_arrow">
													<div class="st_adults_children">
														...
														<div class="input-number-ticket">
															<input type="number" name="number_adults" min="0"
																max="10" required>
														</div>
													...
													<div class="st_adults_children">
														...
														<div class="input-number-ticket">
															<input type="number" name="number_children" min="0"
																max="10">
											...
											<div class="g-recaptcha"
												data-sitekey="6Ld3L10aAAAAAPAKJ-94qhAv-m01T2fYZtX73nEO"></div>
											<input class="btn-booking btn" name='submit' value="Book now"
												type="submit">


											<input type="hidden" name="tour_name"
												value="Daytrip to Shahrisabz" />
