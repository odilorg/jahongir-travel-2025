								...
								@foreach ($relatedTours as $relatedTour)
										...
										<div class="item_border item-product">
											<div class="post_images">
												<a href="{{ route('tours.country_tour.show', ['country_slug' => $relatedTour->country_slug, 'slug' => $relatedTour->slug]) }}">
											...
											<div class="read_more">
												...
												<a rel="nofollow" href="{{ route('tours.country_tour.show', ['country_slug' => $relatedTour->country_slug, 'slug' => $relatedTour->slug]) }}"
