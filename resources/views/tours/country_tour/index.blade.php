...
@section('title', $tour->name ?? 'Tours from '.   ucfirst($countrySlug)  )
						...
						<li class="item-tour col-md-4 col-sm-6 product">
							<div class="item_border item-product">
								<div class="post_images">
									<a href="{{ route('tours.country_tour.show', ['country_slug' => $tour->country_slug, 'slug' => $tour->slug]) }}" rel="bookmark">
								...
								<div class="wrapper_content">
									<div class="post_title"><h4>
										<a href="{{ route('tours.country_tour.show', ['country_slug' => $tour->country_slug, 'slug' => $tour->slug]) }}" rel="bookmark">  {{ $tour->name }}</a>
									</h4></div>
								...
								<div class="read_more">
									...
									<a rel="nofollow" href="{{ route('tours.country_tour.show', ['country_slug' => $tour->country_slug, 'slug' => $tour->slug]) }}" class="button product_type_tour_phys add_to_cart_button">Read more</a>
								</div>
							</div>
						</li>
						@endforeach
