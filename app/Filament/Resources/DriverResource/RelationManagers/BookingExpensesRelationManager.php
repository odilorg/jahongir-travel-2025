...
class BookingExpensesRelationManager extends RelationManager
{
    protected static string $relationship = 'bookingExpenses';
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->required()
                ->options(function () {
                    $driverId = $this->ownerRecord->id; // Get guide ID from RelationManager context

                    return Booking::with('tour') // Load tour relationship
                        ->where('driver_id', $driverId) // Filter only this guide's bookings
                        ->get()
